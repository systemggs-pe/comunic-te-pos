  ...
  return {
    ...
    */
        ...
        case 924:
          {
            ...
            while ((codelen = code.length) > 0) {
              ...
              if (sublen == 6) {
                var t = (0, _bcmathMin.bcmul)("" + this._ord(code.charAt(0)), "1099511627776");
                t = (0, _bcmathMin.bcadd)(t, (0, _bcmathMin.bcmul)("" + this._ord(code.charAt(1)), "4294967296"));
                t = (0, _bcmathMin.bcadd)(t, (0, _bcmathMin.bcmul)("" + this._ord(code.charAt(2)), "16777216"));
                t = (0, _bcmathMin.bcadd)(t, (0, _bcmathMin.bcmul)("" + this._ord(code.charAt(3)), "65536"));
                t = (0, _bcmathMin.bcadd)(t, (0, _bcmathMin.bcmul)("" + this._ord(code.charAt(4)), "256"));
                t = (0, _bcmathMin.bcadd)(t, "" + this._ord(code.charAt(5)));
                // tmp array for the 6 bytes block
                var cw6 = [];
                do {
                  var d = this._my_bcmod(t, "900");
                  t = (0, _bcmathMin.bcdiv)(t, "900");
    ...
    _intval: function _intval(mixed_var, base) {
      ...
      var type = typeof mixed_var === "undefined" ? "undefined" : _typeof(mixed_var);
    ...
    _array_search: function _array_search(needle, haystack, argStrict) {
      ...
      if (haystack && (typeof haystack === "undefined" ? "undefined" : _typeof(haystack)) === "object" && haystack.change_key_case) {
...
exports.bcadd = bcadd;
exports.bcsub = bcsub;
exports.bccomp = bccomp;
exports.bcscale = bcscale;
exports.bcdiv = bcdiv;
exports.bcmul = bcmul;
exports.bcround = bcround;
/**
